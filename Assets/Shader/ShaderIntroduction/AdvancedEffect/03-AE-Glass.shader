Shader "Flecheria/ShaderIntroduction/AE/03-AE-Glass"
{
	Properties
	{
		_MainTex ("Texture", 2D) = "white" {}
		_NormalTex ("Bump/Normal", 2D) = "white" {}
		_ScaleUV ("Scale X", Range(1, 10)) = 1
	}
	SubShader
	{
		...
		Pass
		{
			...
			float4 _GrabTexture_TexelSize; // this depend on resolutin and could be bigger than a pixel
